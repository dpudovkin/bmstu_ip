...
require 'json'
HOST = 'http://localhost:3000/number/input'
...
describe 'test' do
  ...
  it 'no number' do
    ...
    Selenium::WebDriver::Wait.new(timeout: 30)
                             .until { @driver.find_element(:id, 'result').text == "Дружественных чисел нет" }
  ...
  it 'incorrect data' do
    ...
    @driver.find_element(:css, 'html').click
    Selenium::WebDriver::Wait.new(timeout: 30)
                             .until { @driver.find_element(:id, 'result').text == "Некорректные данные" }
    sleep 1
  end

  it 'correct data: n equals 1000' do
    @driver.get('http://localhost:3000/number/input')
    @driver.find_element(:id, 'number').click
    ...
    Selenium::WebDriver::Wait.new(timeout: 30)
                             .until { @driver.find_element(:css, 'caption').text == "Результат" }
